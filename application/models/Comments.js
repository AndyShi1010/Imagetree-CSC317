...
CommentModel.getCommentsForPost = (postId) => {
    let baseSQL = "SELECT u.username, u.userphoto, c.comment, c.created, c.id FROM comments c JOIN users u on u.id=fk_authorid WHERE c.fk_postid=? ORDER BY c.created DESC";

...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `pouserssts to users` FOREIGN KEY (`fk_userid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `users` (
  ...
  `userphoto` varchar(4096) NOT NULL,
...
-- Dump completed on 2020-12-22 22:43:51
